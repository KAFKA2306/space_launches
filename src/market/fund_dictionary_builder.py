...
class FundDictionaryBuilder:
    ...
    def extract_all_fund_names_from_history(self) -> Set[str]:
        ...
        try:
            # Search for all processed trade files in interim/trades
            processed_dir = self.base_dir / "data" / "interim" / "trades"
    ...
    def build_comprehensive_dictionary(self) -> Dict:
        ...
        fund_dictionary = {
            "metadata": {
                ...
                "total_funds": 0,
                "sources": ["historical_trades", "resources/securitycode2.csv"],
