...
async def list_notes(request: Request):
    ...
    return templates.TemplateResponse("notes_index.html", {"request": request, "notes": notes})
...
async def get_note(request: Request, symbol: str):
    ...
    return templates.TemplateResponse("note.html", {"request": request, "symbol": symbol, "content": content_html})
